...
<body>
    ...
    <div class="container-fluid justify-content-center col-11 col-xl-4" style="padding: 0px;margin-bottom: 10px;">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <input type="radio" value="xyz" name="xyz">
                    <span>Select Wrong Package</span>
                </div>
                <div class="col-12">
                    <input type="radio" value="xyz" name="xyz">
                ...
                <div class="col-12">
                    <input type="radio" value="xyz" name="xyz">
                    <span>Delay to accept order</span>
                </div>
                <div class="col-12">
                    <input type="radio" value="xyz" name="xyz">
                    <span>Other</span>

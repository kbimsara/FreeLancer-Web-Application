...
<body style="background-color: #dadada; ">
    ...
    <div class="container-fluid col-12 col-xl-8 justify-content-center">
                        ...
                        <div class="row justify-content-center brd bg-white m-1">
                            <div class="col-12">
                                <div class="row" style="margin: 5px;">
                                    <div class="col-12">
                                        <spam class="txt-s">Graphics & Design</spam>
                                    </div>
                                    <div class="col-12">
                                        <spam class="txt-s">Digital Marketing</spam>
                                    </div>
                                    <div class="col-12">
                                        <spam class="txt-s">Video & Animation</spam>
                                    </div>
                                    <div class="col-12">
                                        <spam class="txt-s">Music & Audio</spam>
                                    </div>
                                    <div class="col-12">
                                        <spam class="txt-s">Graphics & Design</spam>
                                    </div>

...
<body style="background-color: #dadada;">
    ...
    ?>
    <div class="container-fluid col-xl-8 col-12 justify-content-center mn">
        <div class="row justify-content-center m-2">
            <div class="col-xl-6 col-12" style="padding: 0px; margin: 0px;">
                <div class="row">
                    <?php
                    ...
                    $query_search = "SELECT f_name,l_name,user_img FROM user WHERE user_id='$user_id';";
                    ...
                    <div class="col-12" style="text-align: center;">
                        <img src="./user-dp/<?php echo $user_img; ?>" class="profile-pic" alt="Avater">
                        <h3><?php echo "$f_name $l_name"; ?></h3>
                    </div>
                    <div class="col-12">
                        <div class="c-card-2 bg-white m-2">
                            <a href="./acc-switch.php">
                                <div class="row m-2">
                            ...
                            <a href="./Verification-nic-user.php">
                                <div class="row m-2">
                                    <div class="col-2" style="text-align: right;">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="c-card-2 bg-white m-2">
                            ...
                            <hr style="background-color: #dadada;">
                            <a href="./post-rq-active.php">
                                <div class="row m-2">
                                    <div class="col-2" style="text-align: right;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-bookmark-dash" viewBox="0 0 16 16">

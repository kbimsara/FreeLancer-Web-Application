...
<body>
    ...
    <div class="container-fluid mn" style="padding: 0px; margin: 0px;">
        ...
        if (isset($_GET['cid'])) {
            ...
            $query_search = "SELECT * from `category` WHERE c_id ='$id';";
        ...
        <div class="container-fluid" style="padding: 0px;padding-left: 5px; margin: 0px;">
            ...
            <div class="section-btn">
                ...
                if (isset($_GET['cid'])) {
                    ...
                    $query_search = "SELECT * from `category` inner join `service` on `category`.c_id=`service`.c_id WHERE category.c_id ='$id';";
                    $query_run_search = mysqli_query($Connector, $query_search);
        ...
        <div class="container-fluid" style="padding: 0px;padding-left: 5px; margin: 0px;">
            ...
            <div class="section-btn">
                ...
                $query_asc = "SELECT DISTINCT(user_id) FROM rate WHERE NOT user_id='$user_ids' ORDER BY sl_rate DESC;";
                $query_asc_run = mysqli_query($Connector, $query_asc);
                while ($row = mysqli_fetch_array($query_asc_run)) {
                    $user_id1 = $row['user_id'];

                    $query_search = "SELECT * FROM `request_post` WHERE user_id='$user_id1' AND c_id='$id' AND NOT rq_status='close';";
                    ...
                    while ($row = mysqli_fetch_array($query_run)) {
                        ...
                        $query_search3 = "SELECT u* FROM `user`WHERE user_id='$user_id';";
        ...
        $query = "SELECT * FROM `service` WHERE c_id='$id';";
        $queryrr = mysqli_query($Connector, $query);

        while ($row = mysqli_fetch_array($queryrr)) {
            $s_id = $row['s_id'];
            $s_name = $row['s_name'];
            $c_id = $row['c_id'];
        ...
        ?>
            <!-- Logo Design -->
            <div class="container-fluid" style="padding: 0px;padding-left: 5px; margin: 0px;">
                <span class="section-title"><?php echo $s_name; ?></span>
                <div class="section-btn">
                    <?php
                    $query_search = "SELECT * FROM `request_post` WHERE s_id='$s_id' AND NOT user_id='$user_ids' AND NOT rq_status='close';";
                    $query_run = mysqli_query($Connector, $query_search);

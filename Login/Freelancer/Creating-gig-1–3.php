        ...
        <form action="./action/action-publish-gig.php" method="post" enctype="multipart/form-data">
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-xl-10 justify-content-center" style="text-align: center;">
                    ...
                    <button type="button" class="btn btn-outline-primary m-1 active">Packege 3</button>
                </div>
                <!-- pk name -->
                <div class="col-12 col-xl-10 justify-content-center">
                    ...
                    <textarea class="form-control brd m-1" id="title3" name="title3" rows="1" required></textarea>
                </div>
                <!-- img -->
                <div class="col-12 col-xl-10 justify-content-center">
                    <div class="row">
                        <div class="col-12">
                            <h5 class="clr">Images (3rd one)</h5>
                        ...
                        <div class="col-12" style="text-align: center;">
                            <div class="custom-file m-1 col-xl-5 col-11">
                                <input type="file" class="custom-file-input btn-primary clr brd" name="image3" id="image3">
                ...
                <div class="col-12 col-xl-10 justify-content-center">
                    ...
                    <textarea class="form-control brd m-1" rows="4" id="description3" name="description3"></textarea>
                </div>
                <!-- Price -->
                <div class="col-12 col-xl-10 justify-content-center">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <input type="text" class="form-control" id="stPrice3" name="stPrice3" placeholder="LKR 10,000.00">
                        </div>
                    </div>
                </div>
                <!-- duration -->
                <div class="col-12 col-xl-10 justify-content-center">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <input type="number" class="form-control" id="duration3" name="duration3" placeholder="5">
                        </div>
                    </div>
                </div>
                <!-- submit btn -->
                <div class="col-12 col-xl-10 justify-content-center" style="text-align: center;">
                    <button type="submit" class="btn btn-primary m-1" name="next3" data-toggle="modal" data-target="#staticBackdrop">Next</button>
                </div>

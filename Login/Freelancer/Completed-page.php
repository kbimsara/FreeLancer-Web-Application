...
<body>
    ...
    <div class="container-fluid mn">
        ...
        <div class="row justify-content-center">
            <div class="col-12 justify-content-center" style="text-align: center;">
                <a href="./Orders-page.php">
                    <button type="button" class="btn btn-primary m-1">Order</button>
                </a>
                <a href="./Orders-page-ongoing.php">
                    <button type="button" class="btn btn-primary m-1">Ongoing</button>
                </a>
                <a href="./Completed-page.php">
                    <button type="button" class="btn btn-primary m-1 active">Completed page</button>
                </a>
            </div>
        </div>
        ...
        <?php
            ...
            $query_search = "SELECT * FROM `orders` WHERE seller_id='$seller_id' AND order_status='complete';";
            ...
            ?>
                <div class="c-card-3 col-xl-3 col-11 m-1">
                    <a href="./Completed-page-2.php?order_id=<?php echo $order_id; ?>">

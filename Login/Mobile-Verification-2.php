                ...
                <div class="c-card-2 bg-white" style="padding: 15px;">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-xl-10 m-2">
                            ...
                            <input type="text" class="form-control input-pd" id="exampleInputEmail1" placeholder="Enter mobile number">
                        </div>
                        <div class="col-11 col-xl-10 m-2" style="text-align: center;">
                            <p class="txt-s">We will send an one time password
                                on this mobile number</p>
                        </div>
                        <div class="col-12 col-xl-10 m-2" style="text-align: center;">
                            <a href="./Mobile-Verification-3.php">

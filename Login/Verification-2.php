            ...
            <div class="col-12 col-xl-10">
                <div class="row">
                    ...
                    <div class="col-12" style="text-align: center;">
                        <p class="txt-s">Upload your NIC / Driving license Or Passport</p>
                        <p class="clr">Front</p>
                        <div class="custom-file m-1 col-xl-5 col-11">
                            <input type="file" class="custom-file-input btn-primary clr brd" id="customFile">
                            <label class="custom-file-label clr" for="customFile">Select Image</label>
                        </div>
                    ...
                    <div class="col-12" style="text-align: center;">
                        <p class="txt-s">Hold your id and take a selfie</p>
                        <p class="clr">Upload</p>
                        <div class="custom-file m-1 col-xl-5 col-11">
                            <input type="file" class="custom-file-input btn-primary clr brd" id="customFile">
                            <label class="custom-file-label clr" for="customFile">Select Image</label>
                        </div>

    ...
    <div class="container-fluid mn" style="padding: 0px; margin: 0px;">
        ...
        <div class="container-fluid" style="padding: 0px;padding-left: 5px; margin: 0px;">
            ...
            <div class="section-btn">
                ...
                $query_ctr_search = "SELECT * FROM category JOIN `service` ON category.c_id=`service`.c_id WHERE category.c_id='$c_id';";
        ...
        <div class="container-fluid" style="padding: 0px;padding-left: 5px; margin: 0px;">
            ...
            <div class="section-btn">
                ...
                while ($row = mysqli_fetch_array($query_ctr_run)) {
                    $s_id = $row['s_id'];
                    $query_search = "SELECT * FROM gig JOIN seller ON gig.seller_id=seller.seller_id JOIN user ON seller.user_id=user.user_id WHERE gig.s_id='$s_id' AND NOT seller.seller_id='$seller_id' ORDER BY gig.crt_date DESC;";
                    $query_run = mysqli_query($Connector, $query_search);
                    while ($row = mysqli_fetch_array($query_run)) {
                        $gig_id = $row['gig_id'];
                        $description = $row['description'];

                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                        <div class="card-body">
                                            ...
                                            <center>
                                                <a href="./order-review.php?gig_id=<?php echo "$gig_id"; ?>&pack=<?php echo "$p1_title"; ?>">
                                                    <button type="button" class="btn btn-primary btn-sm">Continue (LKR <?php echo "$package_1"; ?>)</button>
                                                </a>
                                            </center>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                        <div class="card-body">
                                            ...
                                            <center>
                                                <a href="./order-review.php?gig_id=<?php echo "$gig_id"; ?>&pack=<?php echo "$p2_title"; ?>">
                                                    <button type="button" class="btn btn-primary btn-sm">Continue (LKR <?php echo "$package_2"; ?>)</button>
                                                </a>
                                            </center>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                                        <div class="card-body">
                                            ...
                                            <center>
                                                <a href="./order-review.php?gig_id=<?php echo "$gig_id"; ?>&pack=<?php echo "$p3_title"; ?>">
                                                    <button type="button" class="btn btn-primary btn-sm">Continue (LKR <?php echo "$package_3"; ?>)</button>
                                                </a>
                                            </center>
                                        </div>
                                    </div>

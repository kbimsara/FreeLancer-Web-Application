...
<body>
    ...
    <div class="container-fluid mn">
        ...
        <div class="row justify-content-center">
            <div class="col-12 justify-content-center" style="text-align: center;">
                <a href="./Orders-page.php">
                    <button type="button" class="btn btn-primary m-1 active">Order</button>
                </a>
                <a href="./Orders-page-ongoing.php">
                    <button type="button" class="btn btn-primary m-1">Ongoing</button>
                </a>
                <a href="./Completed-page.php">
                    <button type="button" class="btn btn-primary m-1">Completed page</button>
                </a>
            </div>
        </div>
        <div class="row justify-content-center" style="margin: 0px;">
            ...
            $query_search = "SELECT * FROM `orders` JOIN user ON orders.user_id=user.user_id WHERE seller_id='$seller_id' AND order_status='';";
            ...
            ?>
                <div class="c-card-3 col-xl-3 col-11 m-1">

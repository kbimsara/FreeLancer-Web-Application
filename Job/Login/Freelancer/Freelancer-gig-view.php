...
<body style="background-color: #dadada;">
    ...
    if (isset($_GET['gigid'])) {
        ...
        $query_search = "SELECT * FROM gig JOIN seller on gig.seller_id=seller.seller_id JOIN user on seller.user_id=user.user_id WHERE gig.gig_id='$gig_id';";
    ...
    ?>
    <div class="container-fluid col-12 col-sm-12 col-md-11 col-lg-10 col-xl-10 mn justify-content-center" style="padding: 0px;">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img src="./img/<?php echo "$img2"; ?>" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="./img/<?php echo "$img3"; ?>" class="d-block w-100" alt="...">
                </div>
            </div>
        </div>
                            ...
                            <div class="accordion" id="accordionExample">
                                <div class="card">
                                    <div class="card-header" id="headingOne">
                                        <h2 class="mb-0">
                                            <button class="btn btn-link btn-block text-left pack-btn" type="button" select-post-bide.phpdata-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            <?php echo "$p1_title"; ?>
                                            </button>
                                        </h2>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingTwo">
                                        <h2 class="mb-0">
                                            <button class="btn btn-link btn-block text-left collapsed pack-btn" select-post-bide.phptype="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                            <?php echo "$p2_title"; ?>
                                            </button>
                                        </h2>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingThree">
                                        <h2 class="mb-0">
                                            <button class="btn btn-link btn-block text-left collapsed pack-btn" select-post-bide.phptype="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                            <?php echo "$p3_title"; ?>
                                            </button>
                                        </h2>
                                    </div>

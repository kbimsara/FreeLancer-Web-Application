                    ...
                    <div class="pk-box2 bg-light txt-s" style="padding: 10px; margin: 0px;">
                        <div class="fl-top">
                            ...
                            while ($row = mysqli_fetch_array($query_run)) {
                                ...
                                $query_searchrt = "SELECT * FROM rate JOIN gig ON rate.gig_id=gig.gig_id WHERE rate.user_id='$user_id';";
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <img src="../Client/user-dp/<?php echo $user_img; ?>" class="fl-img" alt="avatar">
                                </div>
                                <div class="col-9">
                                    <!-- Rating -->
                                    <?php
                                    ...
                                    $query_search22 = "SELECT gig.seller_id,rate.user_rate FROM rate JOIN gig ON rate.gig_id=gig.gig_id WHERE seller_id='$seller_id';";
                ...
                <div class="container-fluid pk-box2 bg-light m-1" style="text-align: left;">
                    ...
                    <form method="post">
                        <div class="row justify-content-center">
                            ...
                            $query_search11 = "SELECT * FROM user JOIN seller ON user.user_id=seller.user_id JOIN gig ON seller.seller_id=gig.seller_id WHERE seller.seller_id='$seller_id';";
                            $query_run11 = mysqli_query($Connector, $query_search11);
                            ...
                            while ($row = mysqli_fetch_array($query_run11)) {
                                ...
                                $query_searchcmplt = "SELECT COUNT(orders.gig_id) AS count FROM `orders` JOIN gig ON orders.gig_id=gig.gig_id JOIN service ON gig.s_id=service.s_id WHERE gig.seller_id='$seller_id' AND orders.order_status='complete' AND orders.gig_id='$gig_id';";
                            ...
                            ?>
                                <a href="./Freelancer-gig-view.php?gigid=<?php echo "$gig_id"; ?>">
                                    <div class="card m-4 c-card-2" style="width: 18rem;">
                                        <img src="./img/<?php echo "$img"; ?>" class="card-img-top brd" alt="Responsive image">
                            ...
                            $query_admin_run = mysqli_query($Connector, $query_admin);

                            while ($row = mysqli_fetch_array($query_admin_run)) {
                            ...
                            ?>
                                <div class="col-12" style="text-align: center;">
                                    <a href="./Creating-gig-1–1.php">
                                        <button type="button" class="btn btn-primary m-4">Create Gig</button>
                                    </a>
                                </div>
                            <?php
                            } else {
                            ?><script>
                                    function msg() {
                                        Swal.fire({
                                            icon: 'error',
                                            title: 'Limit',
                                            text: 'Gig limit(<?php echo $gig_count; ?>)!',
                                        })
                                    }
                                </script>
                                <div class="col-12" style="text-align: center;">
                                    <button type="button" class="btn btn-primary m-4" onclick="msg()">Create Gig</button>
                                </div>
                            <?php
                            }
